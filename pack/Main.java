...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        User user1 = new User("Diana", "nick1", 14);
        User user2 = new User("Vova", "nick2", 19);
        User user3 = new User("Vlad", "nick3", 22);
        ...
        System.out.println("Сравнение одинаковых пользователей: " +
                new User("Diana", "nick1", 14).equals(
                        new User("Diana", "nick1", 14)));
        System.out.println("Сравнение первого и второго пользователя: " +
                user1.equals(
                        user2));

        System.out.println(userList.contains(new User("Vova", "nick2", 19)));
        userList.remove(new User("Vova", "nick2", 19));
        ...
        userList1.add(new User("Diana", "nick1", 14));
        userList2.add(new User("Vova", "nick2", 19));
        userList3.add(new User("Vlad", "nick3", 22));
        ...
        tree.add("Рогинский");
        tree.add("Овсюченко");
        tree.add("Балановская");
        tree.add("Именинник");
        tree.add("Санжаров");
        tree.add("Калина");

        System.out.println("Вывод первых 4 фамилий: ");
